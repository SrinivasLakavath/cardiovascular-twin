...
def prepare_data(csv_path=None):
    if csv_path is None:
        csv_path = os.path.join(PROJECT_ROOT, 'data', 'raw', 'synthetic_dataset.csv')
    """
...
def main():
    ...
    print("\nSaving model...")
    import joblib
    weights_dir = os.path.join(SRC_DIR, 'twin_model', 'weights')
    os.makedirs(weights_dir, exist_ok=True)
    joblib.dump(model, os.path.join(weights_dir, 'surrogate_twin.pkl'))
    print("Model saved to: " + os.path.join(weights_dir, 'surrogate_twin.pkl'))
    
    # Save encoders
    joblib.dump(encoders, os.path.join(weights_dir, 'encoders.pkl'))
    print("Encoders saved to: " + os.path.join(weights_dir, 'encoders.pkl'))
    
    # Save feature names
    joblib.dump(feature_names, os.path.join(weights_dir, 'feature_names.pkl'))
    print("Feature names saved to: " + os.path.join(weights_dir, 'feature_names.pkl'))
